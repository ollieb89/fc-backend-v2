"""
Django settings for fc-backend-v2 project.
...
ROOT_URLCONF = 'fc-backend-v2.urls'
...
WSGI_APPLICATION = 'fc-backend-v2.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'restaurant_review', 'static'),
]
STATIC_URL = 'static/'
