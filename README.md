...
| [whitenoise](https://pypi.org/project/whitenoise/) | Static file serving for WSGI applications, used in the deployed app. <br><br> This package is used in the [fc-backend-v2/production.py](./fc-backend-v2/production.py) file, which configures production settings. |
